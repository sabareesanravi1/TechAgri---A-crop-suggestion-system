...
var handles = ["SELECT STATE","Andaman and Nicobar Islands","Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chhattisgarh","Dadra and Nagar Haveli","Daman and Diu","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka",
...
function selct_district($val)
{
  ...
  $('#thirdlist').html(options);
   ...
   if($val=='Andaman and Nicobar Islands') {
    var andaman = ["NICOBARS","NORTH AND MIDDLE ANDAMAN","SOUTH ANDAMANS"];
    $(function() {
   var options = '';
   ...
   andaman = ["KHARIF","RABI","WHOLE YEAR"];
   $(function() {
   options = '';
   for (var i = 0; i < andaman.length; i++) {
       options += '<option value="' + andaman[i] + '">' + andaman[i] + '</option>';
 ...
 if($val=='Andhra Pradesh') {
  ...
  assam = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
  $(function() {
  options = '';
  for (var i = 0; i < assam.length; i++) {
    options += '<option value="' + assam[i] + '">' + assam[i] + '</option>';
  ...
  bihar = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
  $(function() {
  options = '';
  ...
  $('#secondlist').html(options);
   ...
   Chhattisgarh = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","SUMMER"];
   $(function() {
  options = '';
  ...
  dadra = ["KHARIF","RABI","WINTER"];
  $(function() {
  options = '';
  for ( i = 0; i < dadra.length; i++) {
     options += '<option value="' + dadra[i] + '">' + dadra[i] + '</option>';
  }
  $('#thirdlist').html(options);
  });
  ...
  daman = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
  $(function() {
  options = '';
  ...
  gujarat = ["KHARIF","RABI","WHOLE YEAR","SUMMER"];
$(function() {
options = '';
...
himachal = ["KHARIF","RABI","WHOLE YEAR"];
$(function() {
options = '';
for ( i = 0; i < himachal.length; i++) {
   options += '<option value="' + himachal[i] + '">' + himachal[i] + '</option>';
}
$('#thirdlist').html(options);
});
...
jammu = ["KHARIF","RABI","WHOLE YEAR"];
$(function() {
options = '';
for ( i = 0; i < jammu.length; i++) {
   options += '<option value="' + jammu[i] + '">' + jammu[i] + '</option>';
}
$('#thirdlist').html(options);
});
...
jharkhand = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER"];
$(function() {
options = '';
...
karnataka = ["KHARIF","RABI","WHOLE YEAR","SUMMER"];
$(function() {
options = '';
...
kerala = ["AUTUMN","KHARIF","WHOLE YEAR","WINTER","SUMMER"];
$(function() {
options = '';
...
maharashtra = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","SUMMER"];
$(function() {
options = '';
...
manipur = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
$(function() {
options = '';
...
meghalaya = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
$(function() {
options = '';
...
mizoram = ["KHARIF","RABI","WHOLE YEAR"];
$(function() {
options = '';
...
nagaland = ["KHARIF","RABI","WHOLE YEAR"];
$(function() {
options = '';
...
orissa = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
$(function() {
options = '';
for ( i = 0; i < orissa.length; i++) {
   options += '<option value="' + orissa[i] + '">' + orissa[i] + '</option>';
}
$('#thirdlist').html(options);
});
...
puducherry = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
$(function() {
options = '';
for ( i = 0; i < puducherry.length; i++) {
   options += '<option value="' + puducherry[i] + '">' + puducherry[i] + '</option>';
}
$('#thirdlist').html(options);
});
...
rajasthan =["KHARIF","RABI","WHOLE YEAR"];
...
telangana = ["KHARIF","RABI","WHOLE YEAR"];
...
tripura = ["KHARIF","RABI","WHOLE YEAR"];
...
up =["KHARIF","RABI","WHOLE YEAR","SUMMER"];
...
uttarakhand = ["KHARIF","RABI","WHOLE YEAR"];
...
wb = ["AUTUMN","KHARIF","RABI","WHOLE YEAR","WINTER","SUMMER"];
